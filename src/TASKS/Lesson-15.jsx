...
*/
/* 
	https://ru.react.dev/learn/scaling-up-with-reducer-and-context
	Увеличение масштаба с помощью редуктора и контекста
*/
...
/* Ваша функция считается пользовательским хуком, если ее имя начинается с use  */
...
function AddTask() {
	...
	const dispatch = useContext(TasksDispatchContext); // Или так
	// Или так
	// const dispatch = useTasksDispatch();
